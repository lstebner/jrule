...
(function() {
  var JRule, add_events, ready, remove_events, set_text;
  ...
  remove_events = function(events, el) {
    var e, _i, _len, _results;
    _results = [];
    for (_i = 0, _len = events.length; _i < _len; _i++) {
      e = events[_i];
  ...
  JRule.MouseTracker = (function() {
    ...
    MouseTracker.prototype.destroy = function() {
      ...
      return remove_events(this.events);
    };
  ...
  JRule.BorderRulers = (function() {
    ...
    BorderRulers.prototype.setup_events = function() {
      ...
      if (this.opts.show_mouse) {
        ...
        return add_events(this.events, document.body);
      }
    };
    ...
    BorderRulers.prototype.destroy = function() {
      ...
      remove_events(this.events, document.body);
  ...
  JRule.Grid = (function() {
    ...
    Grid.prototype.setup_events = function() {
      ...
      return add_events(this.events, window);
    };
    ...
    Grid.prototype.destroy = function() {
      this.cleanup();
      return remove_events(this.events, window);
    };
