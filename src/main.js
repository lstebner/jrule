...
(function() {
  ...
  JRule.ColorWheel = (function() {
    ...
    ColorWheel.hex_to_rgb = function(hex, as_ints) {
      var b, char, g, proper_hex, r, rgb, val, _i, _len;
      if (hex == null) {
        hex = "ffffff";
      }
      if (as_ints == null) {
  ...
  JRule.Color = (function() {
    ...
    Color.prototype.parse_value = function(value) {
      var pieces, _ref;
      this.value = value;
      if (this.value.indexOf(",") > -1) {
        ...
        return this.hex_value = JRule.ColorWheel.rgb_to_hex(this.r, this.g, this.b);
      } else if (this.value.indexOf("#") > -1) {
        this.hex_value = this.value.replace("#", "");
        return _ref = JRule.ColorWheel.hex_to_rgb(this.hex_value, true), this.r = _ref[0], this.g = _ref[1], this.b = _ref[2], _ref;
      }
    };
    ...
    Color.prototype.style = function(property) {
      var c;
      c = this.a !== 1 ? "rgba(" + (this.rgba()) + ")" : "#" + (this.hex());
      if (property) {
        return "" + property + ": " + c + ";";
      } else {
        return c;
      ...
      keydown = (function(_this) {
        return function(e) {
          ...
          if (e.keyCode === 16) {
            ...
            return _this.draw_box([_this.start_pos, _this.end_pos]);
          }
        };
      })(this);
      this.events.push({
